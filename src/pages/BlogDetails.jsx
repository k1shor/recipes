...
const BlogDetails = () => {
  ...
  const archive = blogs.filter((b) => b.id !== blogId)
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            {!blog ? (
              <div className="p-8">
                ...
                <Link
                  to="/blogs"
                  className={`inline-block mt-5 px-5 py-2 rounded-xl font-semibold shadow transition ${
                    isLight
                      ? "bg-slate-900 text-white hover:opacity-95"
                      : "bg-white text-slate-900 hover:bg-slate-100"
                  }`}
              ...
              <>
                ...
                <div className="p-6 md:p-10">
                  ...
                  <h1 className={`text-2xl md:text-3xl font-extrabold ${isLight ? "text-slate-800" : "text-slate-100"}`}>
                    {blog.title}
                  </h1>
          ...
          <aside
            className={`rounded-3xl border shadow-xl p-6 h-fit ${
              isLight
                ? "bg-white/80 backdrop-blur-xl border-white"
                : "bg-white/5 backdrop-blur-xl border-white/10"
            }`}
